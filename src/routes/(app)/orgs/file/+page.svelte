<!-- /home/aisom/portal/src/routes/(app)/orgs/file/+page.svelte -->
<script>
...
<Card class="flex-1 m-0 d-flex flex-column overflow-hidden rounded-0">
  ...
  <CardBody class="p-0 flex-1 overflow-hidden">
    <div
      class="file-manager h-100"
      class:file-manager-sidebar-mobile-toggled={mobileSidebarToggled}
    >
      <div class="file-manager-toolbar">
        <button type="button" class="btn border-0"
          ><i class="bi bi-plus-lg me-1"></i> File</button
        >
        <button type="button" class="btn border-0"
          ><i class="bi bi-plus-lg me-1"></i> Folder</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-copy"></i> Copy</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-arrows-move"></i> Move</button
        >
        <button type="button" class="btn border-0"
          ><i class="bi me-1 bi-upload"></i> Upload</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-download"></i> Download</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-trash"></i> Delete</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-arrow-clockwise"></i> Restore</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-file-earmark-text"></i> Rename</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-pen"></i> Edit</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-pencil-square"></i> HTML Editor</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-key"></i> Permissions</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-eye"></i> View</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-unlock"></i> Extract</button
        >
        <button type="button" class="btn border-0" disabled
          ><i class="bi me-1 bi-file-earmark-zip"></i> Compress</button
        >
      </div>
      <div class="file-manager-container">
        <div class="file-manager-sidebar">
          <div class="file-manager-sidebar-mobile-toggler">
            <button
              ...
              ><i class="far fa-lg fa-folder"></i></button
            >
          </div>
            ...
            <PerfectScrollbar class="h-100 p-3">
              ...
              <div class="file-tree mb-3">
                <div class="file-node has-sub expand selected">
                  <a href="#/" aria-label="link" class="file-link">
                  ...
                  <div class="file-tree">
                    <div class="file-node has-sub">
                      <a href="#/" aria-label="link" class="file-link">
                        ...
                        <span class="file-info">
                          <span class="file-icon"
                            ><i class="fa fa-folder fa-lg text-warning"
                            ></i></span
                          >
                            ...
                            <div class="file-node">
                              <a href="#/" aria-label="link" class="file-link">
                                ...
                                <span class="file-info">
                                  <span class="file-icon"
                                    ><i
                                      class="far fa-file-code fa-lg text-body text-opacity-50"
                                    ></i></span
                                  >
                    ...
                    <div class="file-node">
                      <a href="#/" aria-label="link" class="file-link">
                        ...
                        <span class="file-info">
                          <span class="file-icon"
                            ><i class="far fa-file-image fa-lg text-success"
                            ></i></span
                          >
          ...
          <div class="file-manager-sidebar-footer">
            <div class="d-flex align-items-center">
              <div class="mx-n1">
                <Icon
                  class="iconify fa-2x text-theme"
              ...
              <div class="flex-1 ps-3 small">
                ...
                <div class="progress h-5px my-1">
                  <div
                    class="progress-bar progress-bar-striped bg-theme"
                    style="width: 80%"
                  ></div>
                </div>
        ...
        <div class="file-manager-content d-flex flex-column">
          <div
            class="mb-0 d-flex flex-wrap text-nowrap px-10px pt-10px pb-0 border-bottom"
          >
            <button
              type="button"
              aria-label="button"
              class="btn btn-sm btn-default me-2 mb-10px px-2"
              ><i class="fa fa-fw fa-home"></i></button
            >
            <button
              type="button"
              aria-label="button"
              class="btn btn-sm btn-default me-2 mb-10px"
              disabled
              ><i class="fa fa-fw fa-arrow-turn-up ms-n1"></i> Up One Level</button
            >
            ...
            <div class="btn-group me-2 mb-10px">
              <button
                ...
                disabled><i class="fa me-1 fa-arrow-left"></i> Back</button
              >
              <button
                type="button"
                aria-label="button"
                class="btn btn-sm btn-default"
                disabled><i class="fa me-1 fa-arrow-right"></i> Forward</button
              >
            </div>
            <button
              type="button"
              aria-label="button"
              class="btn btn-sm btn-default me-2 mb-10px px-2"
              ><i class="fa fa-fw fa-arrows-rotate"></i></button
            >
            ...
            <div class="btn-group me-2 mb-10px">
              ...
              <button
                ...
                aria-label="button"
                class="btn btn-sm btn-default"
                ><i class="far fa-fw fa-square ms-n1"></i> Unselect All</button
              >
            </div>
          </div>
          <div class="flex-1 overflow-hidden">
            <PerfectScrollbar class="h-100 p-0">
              <table
                class="table table-striped table-borderless table-sm m-0 text-nowrap small"
              >
                <thead>
                ...
                <tbody>
                  <tr>
                    <td class="ps-10px border-0 text-center"
                      ><i class="fa fa-folder text-warning fa-lg"></i></td
                    >
                  ...
                  <tr>
                    <td class="ps-10px border-0 text-center"
                      ><i class="far fa-file-image text-teal fa-lg"></i></td
                    >
