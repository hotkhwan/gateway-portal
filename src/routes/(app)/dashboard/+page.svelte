<script lang="ts">
  ...
  onMount(async () => {
    ...
    productData = [
      {
        img: '/img/dashboard/product-1.jpeg',
        no: '1',
        sku: 'SKU90400',
      ...
      {
        img: '/img/dashboard/product-2.jpeg',
        no: '2',
        sku: 'SKU85999',
      ...
      {
        img: '/img/dashboard/product-3.jpeg',
        no: '3',
        sku: 'SKU20400',
      ...
      {
        img: '/img/dashboard/product-4.jpeg',
        no: '4',
        sku: 'SKU19299',
      ...
      {
        img: '/img/dashboard/product-5.jpeg',
        no: '5',
        sku: 'SKU19299',
